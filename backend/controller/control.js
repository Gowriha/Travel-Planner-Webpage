...
const registerUser = async (req, res) => {
  try {
    ...
    console.log("Received registration data:", { name, email, mobile });
    ...
    console.log("Attempting to save user:", { name, email, mobile });
...
const getPackagesByPlace = async (req, res) => {
  ...
  console.log("Backend received request for place:", place); // Log the received place
  try {
